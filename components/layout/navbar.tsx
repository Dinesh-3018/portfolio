...
import brainwave from "../../public/Logowhite.png";
    ...
    >
      <div className={cn(`flex items-center px-5 max-lg:py-4 lg:px-7.5 xl:px-10`)}>
        <Link href="#hero" className={cn(`block w-48 xl:mr-8`)}>
          <Image src={brainwave} alt="brainwave" width={70} height={50} />
        </Link>
            ...
            {navigation?.map((item) => (
              <Link
                ...
                className={cn(
                  ...
                  "px-6 py-6 md:py-5 lg:-mr-0.25 lg:text-xs lg:font-semibold",
                  item.onlyMobile && "lg:hidden",
                  item.url === hash ? "z-2 lg:text-n-1" : "lg:text-n-1/50",
                  "lg:leading-5 lg:hover:text-color-AAsecondary xl:px-12"
                )}
              >
                {item.title}
              </Link>
        ...
        <a href="https://www.linkedin.com/in/dinesh-g-28b71b199/" target="_blank">
          <Button className="hidden lg:flex">Connect with me</Button>
        </a>
